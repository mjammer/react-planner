...
exports.State = exports.HistoryStructure = exports.Catalog = exports.CatalogElement = exports.Scene = exports.DefaultLayers = exports.Group = exports.Layer = exports.Connection = exports.Item = exports.Area = exports.Hole = exports.Line = exports.Vertex = exports.ElementsSet = exports.DefaultGrids = exports.Grid = undefined;
...
var ElementsSet = exports.ElementsSet = function (_Record2) {
  ...
  function ElementsSet() {
    ...
    return _possibleConstructorReturn(this, (ElementsSet.__proto__ || Object.getPrototypeOf(ElementsSet)).call(this, {
      ...
      connections: new _immutable.List(json.connections || [])
    }));
  }
  ...
  connections: new _immutable.List()
}, 'ElementsSet'));
...
var Connection = exports.Connection = function (_Record8) {
  _inherits(Connection, _Record8);
  ...
  function Connection() {
    ...
    return _possibleConstructorReturn(this, (Connection.__proto__ || Object.getPrototypeOf(Connection)).call(this, _extends({}, json, {
      properties: (0, _immutable.fromJS)(json.properties || {})
    })));
  }
...
var Layer = exports.Layer = function (_Record9) {
  ...
  connections: new _immutable.Map(),
  selected: new ElementsSet()
}, 'Layer'));

var Group = exports.Group = function (_Record10) {
...
var Scene = exports.Scene = function (_Record11) {
...
var CatalogElement = exports.CatalogElement = function (_Record12) {
...
var Catalog = exports.Catalog = function (_Record13) {
...
var HistoryStructure = exports.HistoryStructure = function (_Record14) {
...
var State = exports.State = function (_Record15) {
