  ...
  _createClass(Layer, null, [{
    ...
    value: function unselectAll(state, layerID) {
      ...
      if (connections) connections.forEach(function (connection) {
        state = _export.Connection.unselect(state, layerID, connection.id).updatedState;
      });
    ...
    value: function setPropertiesOnSelected(state, layerID, properties) {
      ...
      selected.connections.forEach(function (connectionID) {
        return state = _export.Connection.setProperties(state, layerID, connectionID, properties).updatedState;
      });
    ...
    value: function updatePropertiesOnSelected(state, layerID, properties) {
      ...
      selected.connections.forEach(function (connectionID) {
        return state = _export.Connection.updateProperties(state, layerID, connectionID, properties).updatedState;
      });
